...
public class JsonObjectRequestAuthenticated extends JsonObjectRequest {
    private Context context;
    public JsonObjectRequestAuthenticated(int method, String url, @Nullable JSONObject jsonRequest, Response.Listener<JSONObject> listener, @Nullable Response.ErrorListener errorListener,Context context) {
